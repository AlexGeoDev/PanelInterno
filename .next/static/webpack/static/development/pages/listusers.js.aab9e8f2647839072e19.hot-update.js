    ...
    value: function renderEditable(cellInfo) {
      ...
      return __jsx("div", {
        ...
        onBlur: function onBlur(e) {
          ...
          console.log("id celda: ", cellInfo.original.id); //const update = transactionBusiness.updateSegment(this.state.user.id, this.state.merchantCode)
        },
        __source: {
...
//# sourceMappingURL=listusers.js.aab9e8f2647839072e19.hot-update.js.map