  ...
  constructor(props) {
    ...
    this.state = {
      ...
      listMenu: [
        ...
        {
          url: "/registerPayment-cupocajero",
      ...
      <div className="app-container">
        {this.state.openModal && (
          <Modal onClose={this.closeModal}>
            <React.Fragment>
              ...
              <a href="/cargar?type=bancolombiawithdrawal">
                Cargar Pago Bancolombia
              </a>
        ...
        <div className="row mx-0 h-100">
          <nav className="col-md-2 px-0 h-100">
            <div className="menu h-160">
              <div className="logo-container d-flex flex-column">
                <div className="my-4">
                  <img src="/image/logo-blanco.png" width="150" />
                </div>
              </div>
              ...
              <div className="menulist">
                {listMenu &&
                  listMenu.map((menu) => (
                    <MenuLink key={menu.url} url={menu.url} name={menu.name} />
                  ))}
              </div>
            </div>
          </nav>
